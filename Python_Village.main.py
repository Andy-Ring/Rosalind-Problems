...
# print(SliceString(str, a, b, c, d))


# start = 100
# end = 200

# print(SumOddInt(start, end))

# file = 'C:\\Users\Andrew\\OneDrive - Baylor University\\Documents\\Git Code\\Rosalind Problems\\ini5.txt'

# print(EvenLines(file))
